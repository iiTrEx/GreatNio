...
client.on('ready', () => {
    ...
    client.user.setGame(` $help | ON ${client.guilds.size}  Servers | Beta `, "http://twitch.tv/Streammingg")
...
client.on("message", message => {
   ...
   =================
   رابط | لكي يأتيك على الخاص رابط السيرفر
   =================
   $inv | لكي تدعو البوت الى سيرفرك
   =================
   ...
   =================
   $color {number} | لكي تختار لون واحد من 50 لون
   =================
   $contact {msg} | لكي ترسل رساله لصاحب البوت
   =================
   `)
...
client.on("message", message => {
   ...
   =================
   $clear {number} | ليمسح البوت الشات برقم الذي كتبته
   =================
   $cr-color | لينشئ 50 لون مرتب
   =================
   $del-colors | لمسح 50 لون
   =================
   $bc {msg} | تحت الصيانة
   =================
   `)
...
client.on('message', function(message) {
    if (message.channel.type === "dm") {
        ...
        client.channels.get("اي دي الشات الي تبي يجي فيه اي كلمه تروح للبوت في الخاص").send({ embed: iiMo });
    }
});
...
//-------------------------------------تم اضافه البوت و خروجه
    ...
    client.channels.get("").send(`**GreatNio** has been **added** :white_check_mark: from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
    });
    
    client.on("guildDelete", guild => {
    client.channels.get("").send(`**GreatNio** has been **removed** :x: from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
    });
...
var prefix = "$";
  ...
  var argresult = args.join('378839252932362252 ');
  if (message.author.id == 421767577925058570) return;


if (message.content.startsWith(prefix + 'playing')) {
if (message.author.id !== '378839252932362252') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Type $help','New: Games| العاب','Beta version|تحديث تجريبي','By: iiTrEx| تركس'];
    var i = -1;
    var j = 0;
...
//-------------------------------------تغير الحالة
 ...
 //inv
      client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=421767577925058570&permissions=2080374975&scope=bot`)
...
client.users.get("378839252932362252").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
//-------------------------------------توكن 
client.login("NDIxNzY3NTc3OTI1MDU4NTcw.DYX9Eg.FFfVA__H2SE0OJYVe84sMbe5D6Y")
